	 ...
	 */
	int straight_list_create(list_t*, size_t, straight_list_copy_t, straight_list_destroy_t);
	 ...
	 */
	void straight_list_destroy(list_t*);
	 ...
	 * Post: Ls vacia.
	 */
	void straight_list_clear(list_t*);
	 ...
	 */
	int straight_list_is_empty(const list_t*);
	 ...
	 */
	void straight_list_get(const list_t*, void*);
	 ...
	 */
	int straight_list_move(list_t*, straight_list_movement_t);
	 ...
	 */
	void straight_list_delete(list_t*);
	 ...
	 */
	int straight_list_insert(list_t*, straight_list_movement_t, const void*);
	 ...
	 */
	int straight_list_update(list_t*, const void*);
